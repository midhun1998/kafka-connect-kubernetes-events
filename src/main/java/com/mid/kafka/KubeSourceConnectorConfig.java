...
public class KubeSourceConnectorConfig extends AbstractConfig {
        ...
        private static ConfigDef createConfigDef() {
                ...
                configDef.define(TOPIC_MAPPER_CONFIG, Type.STRING, TOPIC_MAPPER_DEFAULT,
                                Importance.HIGH, TOPIC_MAPPER_DOC)

                                .define(NAMESPACE_CONFIG, Type.STRING, NAMESPACE_DEFAULT,
                                                Importance.HIGH, NAMESPACE_DOC);
